...
namespace COMMANDS
{
    public class CommandParameters
    {
        ...
        public CommandParameters(string[] parameterArray, int startingIndex) 
        { 
        ...
        {
            foreach(string parametersName in parameterNames)
            {
                if(parameters.TryGetValue(parametersName,out string parameterValue))
                {

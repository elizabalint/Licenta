...
public class VariableStore 
{
    ...
    public static bool TryGetValue(string name, out object variable)
    {
        ...
        //Debug.Log($"TryGetValue: {variable}");
        return true;
    ...
    public static bool TrySetValue<T>(string name, T value)
    {
        ...
        //Debug.Log($"TRYSETVALUE: {db.variables[variableName]}");
        return true;
    }
    public static (string[], Database, string) ExtractInfo(string name)
    {
    ...
    public static void RemoveAllVaribles()
    {
        databases.Clear();
    ...
    public static void PrintAllVariables(Database database=null)
    {
        ...
        foreach (var db in databases)
            PrintAllDatabasesVariables(db.Value);
    }

    private static void PrintAllDatabasesVariables(Database database)
    {
        foreach(KeyValuePair<string,Variable> db in database.variables)
        {
            string variableName = db.Key;
            object variableValue = db.Value.Get();

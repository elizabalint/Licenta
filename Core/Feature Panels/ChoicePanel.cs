...
public class ChoicePanel : MonoBehaviour
{
    ...
    private const float BUTTON_MIN_WIDTH = 800;
    private const float BUTTON_MAX_WIDTH = 3000;
    private const float BUTTON_WITH_PADDING = 50;
    private const float BUTTON_HEIGHT_PER_LINE = 50f;
    private const float BUTTON_HEIGHT_PADDING = 20f;

    [SerializeField] private CanvasGroup canvasGroup;
    [SerializeField] private TextMeshProUGUI titleText;
    [SerializeField] private GameObject choiceBottonPrefab;
    ...
    private IEnumerator GenerateChoices(string[] choices)
    {
        ...
        for(int i = 0; i < choices.Length; i++)
        {
            ...
            {
                GameObject newButtonObject = Instantiate(choiceBottonPrefab, buttonLayoutGroup.transform);
            ...
            float buttonWidth = Mathf.Clamp(BUTTON_WITH_PADDING+choiceButton.title.preferredWidth, BUTTON_MIN_WIDTH, BUTTON_MAX_WIDTH);
